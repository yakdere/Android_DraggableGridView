...
If you want to populate more than one resource, basically you can create a Bitmap ArrayList and add every bitmap's file name into this arraylist. 
If you want to you drawable folders instead of assets, you can just check this link: 
